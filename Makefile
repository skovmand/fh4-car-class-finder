...
dev: build/dev build/dev/index.html build/dev/main.js build/dev/styles.css
prod: build/prod build/prod/index.html build/prod/main.min.js build/prod/styles.min.css
