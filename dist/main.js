	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('car-class-container')
					]),
				_List_fromArray(
					[
						A2(
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$class('car-class')
							]),
						_List_fromArray(
							[
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('car-score-container')
					]),
				_List_fromArray(
					[
						A2(
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$class('car-score')
							]),
						_List_fromArray(
							[
								$elm$html$Html$text(
...
var $author$project$Main$sliderView = A2(
	$elm$html$Html$div,
	_List_fromArray(
		[
			$elm$html$Html$Attributes$class('py-8 mx-auto flex')
		]),
	_List_fromArray(
		[
			A2(
			...
			_List_fromArray(
				[
					$elm$html$Html$Attributes$class('py-4 flex-1')
				]),
			_List_fromArray(
				[
					A2(
					...
					_List_fromArray(
						[
							...
							$elm$html$Html$Attributes$value('800'),
...
var $author$project$Main$view = function (model) {
	return A2(
		...
		_List_fromArray(
			[
				$author$project$Main$carClassView(model),
				$author$project$Main$sliderView
			]));
};
